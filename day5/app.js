...
class Person{
    ...
    get health_Rate () {
      ...
      set health_Rate (value) {
        if (value > 100) 
        {   console.log('Sorry you canot enter healhrate higher than 100')
...
class Employee extends Person{
         #salary;
    constructor(full_name, money, sleep_mood, salary, id, email, workMood, isManager)
    { 
        ...
        this.#salary=1000
         ...
         get salary () {
          ...
          set salary (value) {
            if (value < 1000) 
            {   alert('Sorry Salary you canot enter salary less than 1000')
...
class Office extends Employee{
    constructor(full_name, money, sleep_mood, salary,  id, email, workMood, isManager, name)
        {
            super(full_name, money, sleep_mood,salary, id, email, workMood, isManager)
                this.n = name
        }
    hire(employee)
        {   
